...
public class ConfigurationData
{
    ...
    int ballsPerGame = 5;
    int freezerDuration = 2;
    int speedUpDuration = 2;
    float speedUpFactor = 1.3f;
    ...
    void SetConfigurationDataFields(string csvValues)
    {
        ...
        freezerDuration = int.Parse(values[13]);
        speedUpDuration = int.Parse(values[14]);
        speedUpFactor = int.Parse(values[15]);
    }
}
